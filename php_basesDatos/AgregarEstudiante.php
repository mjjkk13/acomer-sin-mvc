...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        // Consulta con JOIN para obtener el idalumnos desde la tabla alumnos y relacionarla con la tabla asistencia
        $stmt1 = $pdo->prepare("
            SELECT a.idalumnos
            FROM alumnos a
            JOIN asistencia asis ON a.idalumnos = asis.alumnos_idalumnos
        ...
        if ($idalumnos) {
            ...
            $stmt2 = $pdo->prepare("
                ...
                WHERE alumnos_idalumnos = :idalumnos
            ");
